...
const tiers = [
  {
    ...
    price: "₱ 5,000",
    accent: "steel",
    desc: "A grassroots contribution that helps cover incidental costs during the selection phase.",
    perks: [
      "Name mention on IOAI PH website",
  ...
  },
  {
    ...
    price: "₱ 10,000",
    accent: "bronze",
    desc: "An entry-level partnership that offsets bootcamp materials and meals for finalists.",
    perks: [
      "Everything in Steel",
  ...
  },
  {
    ...
    price: "₱ 25,000",
    accent: "silver",
    desc: "Co-funds stipends and logistics for the national bootcamp and selection rounds.",
    perks: [
  ...
  },
  {
    ...
    accent: "gold",
    featured: true,
    desc: "Underwrites a meaningful share of training operations and contestant support across the cycle.",
    perks: [
  ...
  },
  {
    ...
    price: "₱ 100,000",
    accent: "platinum",
    desc: "Anchors a major component of the delegation — a significant contribution toward registration and airfare for the 5-person team (4 contestants + 1 team leader).",
    perks: [
      "Everything in Gold",
  ...
  },
  {
    ...
    price: "Bespoke",
    accent: "primary",
    desc: "Lead sponsor of IOAI Philippines. Helps fully fund the delegation — total cost exceeds ₱500,000 for registration and airfare alone, before training, lodging, and equipment. Limited to one organization per cycle.",
    perks: [
