...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    scripts: [
      {
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=G-ZM408408JK",
      },
      {
        children:
          "window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'G-ZM408408JK');",
      },
    ],
  }),
